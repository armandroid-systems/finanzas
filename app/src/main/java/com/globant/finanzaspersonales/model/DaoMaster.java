...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        cat_categoryDao.createTable(db, ifNotExists);
        cat_tdcDao.createTable(db, ifNotExists);
        budgetsDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        ...
        cat_categoryDao.dropTable(db, ifExists);
        cat_tdcDao.dropTable(db, ifExists);
        budgetsDao.dropTable(db, ifExists);
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(cat_categoryDao.class);
        registerDaoClass(cat_tdcDao.class);
        registerDaoClass(budgetsDao.class);
